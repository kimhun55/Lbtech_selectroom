<div class="container">
    ...
    <!--form -->
    <form action="<?php echo site_url('set_department/group_add_save');?>" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="branch_id" value="<?php echo @$data['branchId'];?>">
    </div>

    <div class="form-group">
        <label>branch_name</label>
        <input type="text" class="form-control" name="branch_name" value="<?php echo @$data['branch'];?>">
    </div>
