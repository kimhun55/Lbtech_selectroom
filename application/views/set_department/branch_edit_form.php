<div class="container">
    ...
    <!--form -->
    <form action="<?php echo site_url('set_department/branch_edit_save');?>" method="POST">
    <input type="hidden" class="form-control" name="id" value="<?php echo $data['branchId'];?>">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="branchId3" value="<?php echo $data['branchId3'];?>">
    </div>
