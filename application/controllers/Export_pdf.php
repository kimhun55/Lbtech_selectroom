...
class Export_pdf extends CI_Controller {
	...
	public function std_room_activity($branchid,$group){
		$group_full = $this->status->get_tblgroup_id_data_by_group($branchid,$group);
		...
		$this->load->view('pdf/std_room_activity_view.php',$data);

	}


	public function std_room_orientation($branchid,$group){
		$group_full = $this->status->get_tblgroup_id_data_by_group($branchid,$group);
		...
		$this->load->view('pdf/std_room_std_room_orientation_view.php',$data);
	...
	public function std_room_scan($branchid,$group){
		...
		$this->load->view('pdf/std_room_scan_view.php',$data);
